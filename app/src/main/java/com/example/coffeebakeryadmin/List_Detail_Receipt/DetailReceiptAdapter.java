...
public class DetailReceiptAdapter extends RecyclerView.Adapter<DetailReceiptAdapter.Holder> {
    private List mDetail;
    private Context mContext;

    public DetailReceiptAdapter(List detail, Context context){
        this.mDetail = detail;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DetailReceiptAdapter.Holder(v);
    }
